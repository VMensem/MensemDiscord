...
CREATE TABLE IF NOT EXISTS guild_settings (
    ...
    economy_settings TEXT,
    leveling_settings TEXT,
    clan_settings TEXT,
    event_settings TEXT,
...
CREATE TABLE IF NOT EXISTS voice_personal_rooms (
    personal_room_id INTEGER PRIMARY KEY AUTOINCREMENT,
    guild_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS giveaway_rerolls (
    reroll_id INTEGER PRIMARY KEY AUTOINCREMENT,
    message_id BIGINT REFERENCES giveaways(message_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS antinuke_snapshots (
    ...
    incident_id INTEGER REFERENCES antinuke_incidents(id),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);

...
-- Love Module
CREATE TABLE IF NOT EXISTS love_relationships (
...
CREATE TABLE IF NOT EXISTS love_proposals (
...
CREATE TABLE IF NOT EXISTS love_rooms (
    room_id BIGINT AUTO_INCREMENT PRIMARY KEY,
    guild_id BIGINT NOT NULL,
    relationship_id BIGINT REFERENCES love_relationships(relationship_id) ON DELETE CASCADE,
    channel_id BIGINT NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    UNIQUE KEY (relationship_id)
);

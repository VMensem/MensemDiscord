...
from .config import get_server_type
...
async def upsert_log(
    ...
    *,
    ...
    # Add server_type to payload
    guild_id = key[1] if len(key) > 1 and isinstance(key[1], int) else 0
    payload["server_type"] = get_server_type(guild_id)

...
from .manager import get_owner, update_room_owner
...
async def send_panel(channel: discord.VoiceChannel, owner: discord.Member) -> None:
    embed = discord.Embed(
    ...
    await channel.send(embed=embed, view=VoicePanel(owner.id))
